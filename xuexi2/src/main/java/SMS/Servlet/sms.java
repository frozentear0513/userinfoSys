...
public class sms {
    ...
    public static void main(String[] args) {
        ...
        params.put("account", "C15326813");                              //查看用户名是登录用户中心->验证码短信->产品总览->APIID
        params.put("password", "1570a574af862ae3238268f2b89d9055");    //查看密码请登录用户中心->验证码短信->产品总览->APIKEY
        params.put("mobile", "18482110930");                             // 发送给哪一个手机号
